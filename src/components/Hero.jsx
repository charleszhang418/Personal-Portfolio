    ...
    <section className="min-h-screen flex flex-col justify-start items-center p-5 text-center">
      ...
      { darkMode ? (
        <div className="flex gap-x-8">
          ...
          <h2 className="max-w-screen text-7xl bg-gradient-to-r from-blue-600 to-green-500 inline-block text-transparent bg-clip-text">CHARLES ZHANG</h2>
        ...
        <div className="flex gap-x-8">
          ...
          <h2 className="text-7xl bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 inline-block text-transparent bg-clip-text">CHARLES ZHANG</h2>
