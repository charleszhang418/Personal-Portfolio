...
const Hero = ( { darkMode } ) => {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-start items-center p-5 text-center">
      ...
      <h2 className="w-100 h-auto text-8xl bg-gradient-to-r from-blue-600 to-green-500 inline-block text-transparent bg-clip-text">Charles  </h2>
      <h2 className="inline-block text-8xl text-indigo-400">Zhang</h2>
        ...
        <h2 className="inline-block text-8xl text-blue-400"></h2>
        </div>
